...
class VisitanteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cpf' => "nullable|min:14|max:14|cpf|formato_cpf|unique:visitantes,cpf,{$url},url",
            'bloco_id' => 'required|exists:blocos,id',
            'unidade_id' => 'required|exists:unidades,id',
            'user_id' => 'required|exists:users,id',
            'data_entrada' => 'required|min:10|max:10|',
            'hora_entrada' => 'required|min:5|max:8|',
            'data_saida' => 'required|min:10|max:10|',
            'hora_saida' => 'required|min:5|max:8|',
